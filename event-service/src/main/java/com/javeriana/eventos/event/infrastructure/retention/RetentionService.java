...
public class RetentionService {
    ...
    @SchedulerLock(name = "event-RetentionService",
                   lockAtMostFor = "PT30M",
                   lockAtLeastFor = "PT1M")
    public void limpiar() {
        ...
        try {
            ...
            metrics.recordRun(enviados + fallidos, duracionMs);
            log.info("[retention] Completada: outbox_enviado={}, outbox_fallido={}, duracion={}ms",
                enviados, fallidos, duracionMs);
        } catch (Exception e) {
            metrics.recordError();
