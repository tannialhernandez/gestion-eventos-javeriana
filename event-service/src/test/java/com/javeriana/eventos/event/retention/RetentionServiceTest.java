...
import com.javeriana.eventos.event.infrastructure.retention.RetentionConfig;
import com.javeriana.eventos.event.infrastructure.retention.RetentionMetrics;
...
@DisplayName("RetentionServiceTest - event-service")
class RetentionServiceTest {
    ...
    void debeRegistrarMetricasTrasEjecucion() {
        ...
        assertThat(metrics.filasEliminadas).isEqualTo(10);
