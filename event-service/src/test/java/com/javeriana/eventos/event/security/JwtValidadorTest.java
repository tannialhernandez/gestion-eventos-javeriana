...
import com.javeriana.eventos.event.infrastructure.security.JwtValidador;
...
@DisplayName("JwtValidador — Validación RSA-256 (event-service)")
class JwtValidadorTest {
    ...
    class TokenValido {
        ...
        void debeExtraerSubjectComoUserId() {
            String token = JwtTestHelper.generarToken(usuarioId, List.of("ORGANIZADOR"));
        ...
        void esValido_tokenCorrecto_retornaTrue() {
            String token = JwtTestHelper.generarToken(usuarioId, List.of("SERVICE"));
