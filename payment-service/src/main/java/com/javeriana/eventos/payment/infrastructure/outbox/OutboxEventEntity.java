 ...
 *
 * Outbox Pattern (ADR-011): los eventos de dominio (PagoConfirmado,
 * PagoReembolsado) se persisten aquí dentro de la misma transacción
 * de negocio. El OutboxRelayService los publica a RabbitMQ asíncronamente.
 */
@Entity
